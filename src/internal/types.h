 ...
 * Attribute list
 * ========================================================================= */
typedef struct { char *key; char *value; } __htmlattr__;
 ...
 * CSS Rule
 * ========================================================================= */
typedef struct { char *property; char *value; } __css_declaration__;
 ...
 * Display / flex enums
 * ========================================================================= */
typedef enum { DISPLAY_BLOCK, DISPLAY_FLEX, DISPLAY_INLINE,
               DISPLAY_INLINE_BLOCK, DISPLAY_NONE } __display_type__;

typedef enum { FLEX_DIRECTION_ROW, FLEX_DIRECTION_ROW_REVERSE,
               FLEX_DIRECTION_COLUMN, FLEX_DIRECTION_COLUMN_REVERSE } __flex_direction__;

typedef enum { JUSTIFY_FLEX_START, JUSTIFY_FLEX_END, JUSTIFY_CENTER,
               JUSTIFY_SPACE_BETWEEN, JUSTIFY_SPACE_AROUND,
               JUSTIFY_SPACE_EVENLY } __justify_content__;

typedef enum { ALIGN_FLEX_START, ALIGN_FLEX_END, ALIGN_CENTER,
               ALIGN_STRETCH, ALIGN_BASELINE } __align_items__;

typedef enum { POSITION_STATIC, POSITION_RELATIVE,
               POSITION_ABSOLUTE } __position_type__;
 ...
 * ========================================================================= */
typedef enum {
    CMD_RECT, CMD_TEXT, CMD_IMAGE, CMD_CLIP_PUSH, CMD_CLIP_POP
} __draw_cmd_type__;
